...
import com.allinx.testtaskeffectivemobile.databinding.FragmentWeekendTripBinding
...
class WeekendTripFragment() : Fragment() {

    private var cityFrom = EMPTY_STRING
    private var cityTo = EMPTY_STRING

    private lateinit var binding: FragmentWeekendTripBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentWeekendTripBinding.inflate(inflater,container,false)
        return binding.root
    }
