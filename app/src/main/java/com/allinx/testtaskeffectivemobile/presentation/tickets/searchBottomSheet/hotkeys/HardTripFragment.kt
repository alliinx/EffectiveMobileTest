...
import com.allinx.testtaskeffectivemobile.databinding.FragmentHardTripBinding
...
class HardTripFragment() : Fragment() {

    private var cityFrom = EMPTY_STRING
    private var cityTo = EMPTY_STRING

    private lateinit var binding: FragmentHardTripBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentHardTripBinding.inflate(inflater,container,false)
        return binding.root
    }
